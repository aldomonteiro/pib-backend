...
function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 52:
            ...
            return _context3.abrupt("return", checkSplit(pageId, userId, 1));
  ...
  return function checkLastAction(_x2, _x3) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee5(pageId, userId, source, user) {
    var _txt;
  ...
  return function passThreadControl(_x4, _x5, _x6, _x7) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee6(pageID, sender) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee8(pageID, source) {
    var _ref9, todayIsOpen, todayOpenAt, todayCloseAt, replyMsg, reply;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 2:
            ...
            todayIsOpen = _ref9.todayIsOpen;
            todayOpenAt = _ref9.todayOpenAt;
            todayCloseAt = _ref9.todayCloseAt;
            replyMsg = '';
          ...
          case 11:
            ...
            reply.text = replyMsg + '\n\n' + reply.text;
            return _context8.abrupt("return", reply);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee9(pageID, data, source) {
    var replyMsg, reply;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee10(pageID, categoryID, sizeID) {
    ...
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 63:
            _context10.prev = 63;
            _context10.t1 = _context10["catch"](59);
          ...
          case 80:
            _context10.prev = 80;
            _context10.t2 = _context10["catch"](52);
            _didIteratorError3 = true;
            _iteratorError3 = _context10.t2;
          ...
          case 108:
            return _context10.finish(105);

          case 109:
            return _context10.finish(102);

          case 110:
            return _context10.abrupt("return", flavorsWithPrice);

          case 113:
            _context10.prev = 113;
            _context10.t4 = _context10["catch"](0);
            console.error({
              flavorsAndToppingsErr: _context10.t4
            });
    ...
    }, _callee10, null, [[0, 113], [14, 98, 102, 110], [23, 35, 39, 47], [40,, 42, 46], [52, 80, 84, 92], [59, 63, 67, 75], [68,, 70, 74], [85,, 87, 91], [103,, 105, 109]]);
  }));
...
function () {
  ...
  regeneratorRuntime.mark(function _callee12(pageId, userId) {
    ...
    }, _callee12, null, [[12, 16, 20, 28], [21,, 23, 27]]);
  }));
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee13(pageId, userId, data, user, source) {
    ...
    return regeneratorRuntime.wrap(function _callee14$(_context14) {
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 2:
            prevAnswer = _context14.sent;
            _context14.next = 5;
            return confirmAddressOrAskLocation(pageId, userId, user, source);

          case 5:
            nextQuestion = _context14.sent;
            nextQuestion.text = prevAnswer.text + '\n\n' + nextQuestion.text;
            return _context14.abrupt("return", nextQuestion);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee15(pageId, userId, user, source) {
    var _phone;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee16(pageId, userId, location, user) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee17(pageId, userId, user, source) {
    var addrData;
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 2:
            ...
            return _context17.abrupt("return", confirmAddress(pageId, userId, addrData, user, source));
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee19(pageId, userId, addrData, user, source) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee20(pageId, userId, addrData, source) {
    ...
    return regeneratorRuntime.wrap(function _callee20$(_context20) {
      while (1) {
        switch (_context20.prev = _context20.next) {
          ...
          case 5:
            formattedAddrData = _context20.sent;
            _context20.next = 8;
            return (0, _ordersController.updateOrder)({
              pageId: pageId,
              userId: userId,
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee24(pageId, userId, phone) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee26(pageId, userId, data, user, source) {
    var prevAnswer, nextQuestion;
    return regeneratorRuntime.wrap(function _callee26$(_context26) {
      while (1) {
        switch (_context26.prev = _context26.next) {
          ...
          case 2:
            prevAnswer = _context26.sent;
            _context26.next = 5;
            return askForQuantity(pageId, userId);

          case 5:
            nextQuestion = _context26.sent;
            nextQuestion.text = prevAnswer.text + '\n\n' + nextQuestion.text;
            return _context26.abrupt("return", nextQuestion);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee27(pageId, userId, addrData, source) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee30(pageId, userId, data) {
    var qty, out;
      ...
      while (1) {
        switch (_context31.prev = _context31.next) {
          ...
          case 25:
            ...
            return _context31.abrupt("return", _out);
    ...
    return regeneratorRuntime.wrap(function _callee32$(_context32) {
      while (1) {
        switch (_context32.prev = _context32.next) {
          ...
          case 2:
            prevAnswer = _context32.sent;
            _context32.next = 5;
            return askForSize(pageId, userId);

          case 5:
            nextQuestion = _context32.sent;
            nextQuestion.text = prevAnswer.text + '\n\n' + nextQuestion.text;
            return _context32.abrupt("return", nextQuestion);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee34(pageId, userId, multiple) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee35(pageId, userId, data, multiple) {
    var prevAnswer, nextQuestion;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee39(pageId, userId, multiple, pendingOrder) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee43(pageId, userId, po) {
    ...
    return regeneratorRuntime.wrap(function _callee43$(_context43) {
      while (1) {
        switch (_context43.prev = _context43.next) {
          ...
          case 17:
            _context43.prev = 17;
            _context43.t0 = _context43["catch"](13);
            _didIteratorError6 = true;
            _iteratorError6 = _context43.t0;
    ...
    }, _callee43, null, [[13, 17, 21, 29], [22,, 24, 28]]);
  }));
    ...
    return regeneratorRuntime.wrap(function _callee44$(_context44) {
      while (1) {
        switch (_context44.prev = _context44.next) {
          ...
          case 2:
            prevAnswer = _context44.sent;
            _context44.next = 5;
            return showOrderOrNextItem(pageId, userId);

          case 5:
            nextQuestion = _context44.sent;
            nextQuestion.text = prevAnswer.text + '\n\n' + nextQuestion.text;
            return _context44.abrupt("return", nextQuestion);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee47(pageId, userId) {
    var _options;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee52(pageID, userID, item) {
    var _txt;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee53(pageId, userId, text) {
    var _txtComments;
...
function () {
  ...
  regeneratorRuntime.mark(function _callee54(pageId, userId) {
    ...
    }, _callee54, null, [[9, 13, 17, 25], [18,, 20, 24]]);
  }));
    ...
    return regeneratorRuntime.wrap(function _callee56$(_context56) {
      while (1) {
        switch (_context56.prev = _context56.next) {
          ...
          case 8:
            nextAnswer = _context56.sent;
            nextAnswer.text = prevAnswer.text + '\n\n' + nextAnswer.text;
            return _context56.abrupt("return", nextAnswer);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee59(pageId, userId, item) {
    var _txt, _options;
      ...
      while (1) {
        switch (_context59.prev = _context59.next) {
          ...
          case 8:
            ...
            console.error({
              askForOptionsToChangeErr: _context59.t0
            });
            throw _context59.t0;
...
function () {
  ...
  regeneratorRuntime.mark(function _callee60(pageId, userId, data) {
    ...
    }, _callee60, null, [[9, 13, 17, 25], [18,, 20, 24]]);
  }));
    ...
    return regeneratorRuntime.wrap(function _callee61$(_context61) {
      while (1) {
        switch (_context61.prev = _context61.next) {
          ...
          case 13:
            return _context61.abrupt("return", showFullOrder(pageId, userId));
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee62(pageId, userId, multiple) {
    ...
    return regeneratorRuntime.wrap(function _callee65$(_context65) {
      while (1) {
        switch (_context65.prev = _context65.next) {
          ...
          case 2:
            prevAnswer = _context65.sent;
            _context65.next = 5;
            return askForPaymentType(pageId, userId);

          case 5:
            nextQuestion = _context65.sent;
            nextQuestion.text = prevAnswer.text + '\n\n' + nextQuestion.text;
            return _context65.abrupt("return", nextQuestion);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee67(pageId, userId, item) {
    return regeneratorRuntime.wrap(function _callee67$(_context67) {
      while (1) {
        switch (_context67.prev = _context67.next) {
          case 0:
            return _context67.abrupt("return", askToTypeComments(pageId, userId, item));
      ...
      while (1) {
        switch (_context76.prev = _context76.next) {
          ...
          case 25:
            ...
            _iteratorError10 = _context76.t0;
    ...
    return regeneratorRuntime.wrap(function _callee79$(_context79) {
      while (1) {
        switch (_context79.prev = _context79.next) {
          ...
          case 18:
            size = _context79.sent;
            sizeData = {
              id: size.id,
              size: size.size // Update the order with the unique size and checkSplit

            };
            return _context79.abrupt("return", showSizeCheckSplit(pageId, userId, sizeData));
