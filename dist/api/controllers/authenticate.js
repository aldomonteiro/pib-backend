...
var _users = _interopRequireDefault(require("../models/users"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
  ...
  if (token) {
    _jsonwebtoken.default.verify(token, process.env.JWT_SECRET, function (err, decoded) {
      if (err) {
        ...
        _users.default.findOne({ email: decoded.email }).then(function (user) {
