"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.getOpeningTimes = exports.openingtimes_delete = exports.openingtimes_update = exports.openingtimes_create = exports.openingtimes_get_one = exports.openingtimes_get_all = void 0;var _openingtimes = _interopRequireDefault(require("../models/openingtimes"));
...
var openingtimes_get_all = function openingtimes_get_all(req, res) {
  ...
  if (req.currentUser.activePage) {
    query = _openingtimes.default.find({ pageId: req.currentUser.activePage });
  }
...
exports.openingtimes_get_all = openingtimes_get_all;var openingtimes_get_one = function openingtimes_get_one(req, res) {
  if (req.params && req.params.id) {
    // Filter based on the currentUser
    var pageId = req.currentUser.activePage;

    _openingtimes.default.findOne({ pageId: pageId, store_id: req.params.store_id }, function (err, doc) {
      if (err) {
        res.status(500).json({ message: err.errmsg });
      } else
      {
...
// CREATE A NEW RECORD
exports.openingtimes_get_one = openingtimes_get_one;var openingtimes_create = function openingtimes_create(req, res) {
  if (req.body) {
...
// UPDATE
exports.openingtimes_create = openingtimes_create;var openingtimes_update = function openingtimes_update(req, res) {
  if (req.body && req.body.id) {

    var pageId = req.currentUser.activePage;

    _openingtimes.default.findOne({ pageId: pageId, store_id: req.body.store_id }, function (err, doc) {
      if (!err) {
...
// DELETE
exports.openingtimes_update = openingtimes_update;var openingtimes_delete = function openingtimes_delete(req, res) {

  var pageId = req.currentUser.activePage;

  _openingtimes.default.findOneAndRemove({ pageId: pageId, store_id: req.params.store_id }).
  then(function (result) {
    res.status(200).json(result);
  }).
  catch(function (err) {
...
var getOpeningTimes = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(pageID) {var query;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            // TODO: if is there more than one Store?
            query = _openingtimes.default.findOne({ pageId: pageID });_context.next = 3;return (
              query.exec());case 3:return _context.abrupt("return", _context.sent);case 4:case "end":return _context.stop();}}}, _callee, this);}));return function getOpeningTimes(_x) {return _ref.apply(this, arguments);};}();exports.getOpeningTimes = getOpeningTimes;
