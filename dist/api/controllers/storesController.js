"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.getOpeningTimes = exports.store_delete = exports.store_update = exports.store_create = exports.store_get_one = exports.store_get_all = void 0;var _stores = _interopRequireDefault(require("../models/stores"));
...
var store_get_all = function store_get_all(req, res) {
  ...
  if (req.currentUser.activePage) {
    query = _stores.default.find({ pageId: req.currentUser.activePage });
  }
...
exports.store_get_all = store_get_all;var store_get_one = function store_get_one(req, res) {
  if (req.params && req.params.id) {
    // Filter based on the currentUser
    var pageId = req.currentUser.activePage;

    _stores.default.findOne({ pageId: pageId, id: req.params.id }, function (err, doc) {
      if (err) {
        res.status(500).json({ message: err.errmsg });
      } else
      {
...
// CREATE A NEW RECORD
exports.store_get_one = store_get_one;var store_create = function store_create(req, res) {
  if (req.body) {
...
// UPDATE
exports.store_create = store_create;var store_update = function store_update(req, res) {
  if (req.body && req.body.id) {

    var pageId = req.currentUser.activePage;

    _stores.default.findOne({ pageId: pageId, id: req.body.id }, function (err, doc) {
      if (!err) {
...
// DELETE
exports.store_update = store_update;var store_delete = function store_delete(req, res) {

  var pageId = req.currentUser.activePage;

  _stores.default.findOneAndRemove({ pageId: pageId, id: req.params.id }).
  then(function (result) {
    res.status(200).json(result);
  }).
  catch(function (err) {
...
var getOpeningTimes = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(pageID) {var query, result;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            // TODO: if is there more than one Store?
            query = _stores.default.findOne({ pageId: pageID });_context.next = 3;return (
              query.exec());case 3:result = _context.sent;
            console.log(result);return _context.abrupt("return",
            result);case 6:case "end":return _context.stop();}}}, _callee, this);}));return function getOpeningTimes(_x) {return _ref.apply(this, arguments);};}();exports.getOpeningTimes = getOpeningTimes;
