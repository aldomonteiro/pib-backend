"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.changeAccessToken = exports.users_create = exports.users_auth = void 0;var _users = _interopRequireDefault(require("../models/users"));
...
var users_auth = function users_auth(req, res) {
  if (req.body) {
    ...
    _users.default.findOne({ userID: req.body.userID }, function (err, foundUser) {
      if (err) {
      ...
      if (foundUser) {
        ...
        then(function (data) {
          ...
          newRecord.save().
          then(function (record) {return res.status(200).json({ user: record.toAuthJSON() });}).
...
var users_create = function users_create(req, res) {
  var queryUser = _users.default.findOne({ userID: req.body.userID });
...
exports.users_create = users_create;var changeAccessToken = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(accessToken) {var facebookAccessTokenUrl, params;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            ...
            params = {
              ...
              fb_exchange_token: accessToken };_context.next = 5;return (


              _axios.default.get(facebookAccessTokenUrl, { params: params }).then(function (res) {return res.data;}));case 5:return _context.abrupt("return", _context.sent);case 6:case "end":return _context.stop();}}}, _callee, this);}));return function changeAccessToken(_x) {return _ref.apply(this, arguments);};}();exports.changeAccessToken = changeAccessToken;
